  ...
  return (
    <div className="max-w-sm mx-auto">
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-black text-slate-800 mb-2">Mis turnos</h1>
        <p className="text-slate-500 text-sm">
          Ingresá el teléfono que usaste al agendar para ver tus turnos.
        </p>
      </div>
    ...
    <div className="max-w-sm mx-auto">
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-black text-slate-800 mb-2">
          {nombre ? `Hola, ${nombre.split(' ')[0]}!` : 'Verificar identidad'}
        </h1>
        <p className="text-slate-500 text-sm">
          Te enviamos un código de 4 dígitos al <span className="font-semibold text-slate-700">{telefono}</span>.
        </p>
      </div>
      ...
      {codigoDev && (
        <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 mb-4 text-center">
          <p className="text-xs text-amber-600 font-medium mb-1">Modo desarrollo — código:</p>
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-black text-slate-800">Hola, {nombre.split(' ')[0]}</h1>
          <p className="text-slate-400 text-sm">Tus turnos en Soluciones Dentales</p>
        </div>
      ...
      {turnos.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-slate-500 mb-4">No tenés turnos registrados</p>
          <Link
            href="/turnos"
    ...
    <div className="min-h-screen bg-slate-50">
      <header className="bg-white border-b border-slate-100 shadow-sm sticky top-0 z-40">
        <div className="max-w-lg mx-auto px-4 h-14 flex items-center justify-between">
          ...
          {paso === 'turnos' && (
            <span className="text-xs text-teal-600 font-bold bg-teal-50 px-3 py-1 rounded-full">
              Verificado ✓
            </span>
          )}
        </div>
